...
export default function AdminNotifications() {
    ...
    function refresh() {
        notificationService.listAdmin().then(setNotifications);
    }
        ...
        <div className="space-y-4">
            <div className="flex items-center justify-end">
                <Button
                    ...
                    onClick={() => notificationService.markAllAdminAsRead().then(refresh)}
                >
                    Mark All as Read
                </Button>
            </div>
                ...
                {!notifications ? (
                    ...
                    <div>
                        {notifications.map((n) => (
                            <button
                                key={n.id}
                                onClick={() => notificationService.markAdminAsRead(n.id).then(refresh)}
                                className={cn(
